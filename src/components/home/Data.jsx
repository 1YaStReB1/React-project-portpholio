...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Димасик
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
       ...
       <h3 className="home__subtitle">Фронтенд разработчик</h3>
       <p className="home__description">Липси ха липси ха липси гив ми мани ха, мани на долар</p>
